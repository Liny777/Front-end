  ...
  <body>
    ...
    <div class="cube-container">
      ...
      <div class="cube initial-position">
        ...
        <img class="cube-face-image image-4" src="@/assets/Visulization/Path1.jpg" @click="pathdirect">

        <img class="cube-face-image image-5" src="@/assets/Visulization/Relation1.jpg" @click="relationdirect">

        <img class="cube-face-image image-6" src="@/assets/Visulization/Search1.jpg" @click="searchdirect">

      </div>

    </div>

    <h2>Click the buttons below to rotate the cube</h2>

    <div class="image-buttons">
      <!-- <button class="show-image-1">路径分析功能</button>

      <button class="show-image-2">关联分析功能</button>

      <button class="show-image-3">搜索查询功能</button>

      <button class="show-image-4"><svg><rect x="0" y="0" fill="none" width="100%" height="100%" /></svg>路径分析功能</button> -->
      ...
      <button class="show-image-3"><svg><rect x="0" y="0" fill="none" width="100%" height="100%" /></svg>搜索查询功能</button>

      <button class="show-image-4" />
...
.cube-face-image {
	...
	position: absolute;
	opacity: 0.95;
	border: 0.2rem solid rgb(11, 234, 235);
